...
% Last Modified by GUIDE v2.5 27-Feb-2018 11:11:49
...
if isfield(handles,'pinput')
    fl = sprintf('%.3f,%.3f | %.2f | %.2f | %.2f | %d | %d',min(str2num(handles.int1)),max(str2num(handles.int1)),ws,handles.ovr(handles.c,:),...
    handles.pr(handles.c,:),handles.forder(handles.c,:),handles.ns(handles.c,:));
    f2 = sprintf('%.3f,%.3f | %.2f | %.2f | %.2f | %d | %d',min(str2num(handles.int2)),max(str2num(handles.int2)),ws,handles.ovr(handles.c,:),...
    handles.pr(handles.c,:),handles.forder(handles.c,:),handles.ns(handles.c,:));
else
    fl = sprintf('%.3f,%.3f | %.2f | %.2f | %.2f | %d | %d',min(handles.int1(handles.c,:)),max(handles.int1(handles.c,:)),ws,handles.ovr(handles.c,:),...
    handles.pr(handles.c,:),handles.forder(handles.c,:),handles.ns(handles.c,:));
    f2 = sprintf('%.3f,%.3f | %.2f | %.2f | %.2f | %d | %d',min(handles.int2(handles.c,:)),max(handles.int2(handles.c,:)),ws,handles.ovr(handles.c,:),...
    handles.pr(handles.c,:),handles.forder(handles.c,:),handles.ns(handles.c,:));
end
